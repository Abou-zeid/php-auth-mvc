...
<head>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">Atlas Inventus</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="buttons.html">Enrolled Courses</a>
                            <a class="collapse-item" href="cards.html">Assign Course</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="utilities-color.html">Kid's Learning Progress</a>
                            <a class="collapse-item" href="utilities-border.html">Attendanvce in live Sessions</a>
        ...
        <button class="fab btn btn-primary" id="floatingButton">
                ...
                if (!ticking) {
                    window.requestAnimationFrame(function() {
                        ...
                        if (currentScrollPosition > lastScrollPosition && currentScrollPosition > scrollThreshold) {
                            floatingButton.classList.add('fab-hidden');
                        } 
                        // Show when scrolling up or at top of page
                            ...
                            floatingButton.classList.remove('fab-hidden');
                        }
        ...
        <!-- error and success aler scripts -->
        <script>
